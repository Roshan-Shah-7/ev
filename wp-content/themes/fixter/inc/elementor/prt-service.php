...
class Fixter_Servicebox_Widget extends Widget_Base{
	...
	public function get_title() {
		return esc_attr__( 'Service Box', 'fixter' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'style',
			[
				'label'			=> esc_attr__( 'Select Service Style', 'fixter' ),
		...
		$this->add_control(
			...
			[
				...
				'description' => esc_attr__( 'Sort retrieved service by parameter.', 'fixter' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'DESC',
				'options' => [
...
// Register widget
Plugin::instance()->widgets_manager->register( new Fixter_Servicebox_Widget() );