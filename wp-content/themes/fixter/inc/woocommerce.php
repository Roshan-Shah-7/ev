...
if( function_exists('is_woocommerce') ){  /* Check if WooCommerce plugin activated */
	...
	function tm_wc_loop_buttons(){
		...
		if( class_exists( 'YITH_WCQV_Frontend' ) ) {
			echo '<div class="prt-wc-quickview-btn"><a href="#" class="button yith-wcqv-button" data-product_id="' . get_the_ID() . '">' . esc_attr__('Quick View','fixter') . '</a></div>';
		}
...
function override_pagination_args( $args ) {
	$args['prev_text'] = esc_attr__( 'Prev','fixter' );
	$args['next_text'] = esc_attr__( 'Next','fixter' );
	return $args;
}