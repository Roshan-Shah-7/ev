...
if( is_page() ){
	...
	if( function_exists('tribe_is_upcoming') ){
		if (get_post_type()=='tribe_events'){
			$events_sidebar = !empty($fixter_theme_options['sidebar_events']) ? esc_attr($fixter_theme_options['sidebar_events']) : 'no' ; // Global settings
	...
	if( function_exists('tribe_is_upcoming') ){
		if ( get_post_type() == 'tribe_events' || tribe_is_upcoming() || tribe_is_month() || tribe_is_by_date() || tribe_is_day() || is_single('tribe_events')){
			$events_sidebar = ( isset($fixter_theme_options['sidebar_events']) && trim($fixter_theme_options['sidebar_events'])!='' ) ? esc_attr($fixter_theme_options['sidebar_events']) : 'no' ; // Global settings
			if( $events_sidebar=='right' ){
				$sidebar_right = 'sidebar-events';
			}
		}
	...
	$bbpressSidebar = isset($fixter_theme_options['sidebar_bbpress']) ? esc_attr($fixter_theme_options['sidebar_bbpress']) : 'right' ;
	...
	$sidebar_right = esc_attr($fixter_theme_options['sidebar_post']); // Global settings
	$sidebar_right = 'sidebar-right-blog';
