...
class CSFramework_Option_preyantechnosys_background extends CSFramework_Options {
  ...
  public function output() {
    ...
    $button_title   = ( isset( $button_title ) ) ? $button_title : esc_attr__( 'Upload', 'fixter' );
    $frame_title    = ( isset( $frame_title  ) ) ? $frame_title  : esc_attr__( 'Upload', 'fixter' );
    $insert_title   = ( isset( $insert_title ) ) ? $insert_title : esc_attr__( 'Use Image', 'fixter' );
	...
	$btntext_add    = esc_attr__('Add image','fixter');
	$btntext_change = esc_attr__('Change image','fixter');
	$btntext        = ( empty( $value ) )  ? esc_attr__('Add image','fixter') : esc_attr__('Change image','fixter');
	...
	echo '<div class="cs-image-preview"><div class="cs-preview"><div class="cs-preview-inner">
			...
			<img src="'. esc_attr($preview) .'" alt="' . esc_attr__('preview','fixter') . '" class="'. esc_attr($hidden) .'" />
			<div class="prt-cs-background-heading-noimg'. esc_attr($hidden_text) .'"> ' . esc_attr__('No image selected for background','fixter') . ' </div>
		</div></div></div>';
	...
	echo '<small>'. esc_attr__('BG image repeat','fixter') .'</small>';
	...
	echo '<small>'. esc_attr__('BG image position','fixter') .'</small>';
    echo cs_add_element( array(
        'pseudo'          => true,
        'type'            => 'select',
	...
	echo '<small>'. esc_attr__('BG image attachment','fixter') .'</small>';
    echo cs_add_element( array(
        'pseudo'          => true,
        'type'            => 'select',
	...
	echo '<small>'. esc_attr__('BG image size','fixter') .'</small>';
    echo cs_add_element( array(
        'pseudo'          => true,
        'type'            => 'select',
	...
	if( isset($this->field['color']) && $this->field['color']==false ){
		...
		echo '<small>'. esc_attr__('BG image color','fixter') .'</small>';
		echo cs_add_element( array(
			'pseudo'          => true,
