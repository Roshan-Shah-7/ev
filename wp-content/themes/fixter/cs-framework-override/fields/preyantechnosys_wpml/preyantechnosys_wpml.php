...
class CSFramework_Option_preyantechnosys_wpml extends CSFramework_Options {
  ...
  public function output(){
	...
	$config['box_title']		= esc_attr__( 'Multilingual Fixter Theme', 'fixter' );
	$config['name']				= esc_attr( 'Fixter' ); //name of theme/plugin
	$config['box_description']	= esc_attr__('Fixter theme is fully compatible with WPML - the WordPress Multilingual plugin. WPML lets you add languages to your existing sites and includes advanced translation management.', 'fixter' );
