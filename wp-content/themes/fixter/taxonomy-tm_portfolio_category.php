...
get_header(); ?>
	...
	<section id="primary" class="content-area <?php echo preyantechnosys_sanitize_html_classes(preyantechnosys_sidebar_class('content-area')); ?>">
		...
		<?php if ( have_posts() ) : ?>
			...
			$view   = ( !empty($fixter_theme_options['pfcat_view']) ) ? $fixter_theme_options['pfcat_view'] : 'overlay' ;
			$column = ( !empty($fixter_theme_options['pfcat_column']) ) ? $fixter_theme_options['pfcat_column'] : 'three' ;
