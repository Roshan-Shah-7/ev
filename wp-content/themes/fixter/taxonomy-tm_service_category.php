...
get_header(); ?>
	...
	<section id="primary" class="content-area <?php echo preyantechnosys_sanitize_html_classes(preyantechnosys_sidebar_class('content-area')); ?>">
		...
		<?php if ( have_posts() ) : ?>
			...
			$view   = ( !empty($fixter_theme_options['services_cat_view']) ) ? $fixter_theme_options['services_cat_view'] : 'top-image' ;
			$column = ( !empty($fixter_theme_options['services_cat_column']) ) ? $fixter_theme_options['services_cat_column'] : 'three' ;
