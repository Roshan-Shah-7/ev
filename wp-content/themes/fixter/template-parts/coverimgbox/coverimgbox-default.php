<div class="prt_coverbox_contents <?php if($count == 1) { echo 'active'; } ?>">
	...
	<div class="coverbox-img-reposive" style="background-image: url(<?php echo esc_url($box['icon_image']['url']); ?>)"></div>
</div>