...
$right_content=$fixter_theme_options['footer_copyright_left'];
...
?>
				<div class="col-xs-12 <?php echo esc_attr($left_col_class); ?> <?php if(!empty($right_content)) { ?>prt-footer2-left <?php } ?>">
					<?php
					if( !empty($fixter_theme_options['footer_copyright_left']) ){
					echo do_shortcode( $fixter_theme_options['footer_copyright_left'] );
					}
					?>
				</div><!--.footer menu -->
