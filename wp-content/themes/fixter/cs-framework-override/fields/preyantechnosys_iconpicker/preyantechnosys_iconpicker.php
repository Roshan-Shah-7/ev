...
class CSFramework_Option_preyantechnosys_iconpicker extends CSFramework_Options {
  ...
  public function output(){
	...
	$icon_library_array = array( // all icon library list array
		'themify'        => array( esc_attr__( 'Themify icons', 'fixter' ), 'ti-location-pin'),
		'linecons'       => array( esc_attr__( 'Linecons', 'fixter' ), 'li_star'),
		'kw_fixter'     => array( esc_attr__( 'Fixter Icons', 'fixter' ), 'flaticon-fruits'),
	);
	...
	$icon_picker_html    = '';
	$icon_dropdown_array = array( esc_attr__( 'Font Awesome', 'fixter' )    => 'fontawesome' );
