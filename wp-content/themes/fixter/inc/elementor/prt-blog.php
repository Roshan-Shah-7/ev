...
class Fixter_Blogbox_Widget extends Widget_Base{
	...
	public function get_title() {
		return esc_attr__( 'Blog Box', 'fixter' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'style',
			[
				'label'			=> esc_attr__( 'Select Blogbox Style', 'fixter' ),
				'description'	=> esc_attr__( 'Select Blogbox style.', 'fixter' ),
				'type' => Controls_Manager::SELECT,
				'label_block'	=> true,
				'options' => [
					'left-image'	=> esc_attr( 'BlogBox Left Image Style' ),
		...
		$this->add_control(
			...
			[
				...
				'default' => esc_attr__( 'Latest News', 'fixter' ),
		...
		$this->add_control(
			'exclude_posts',
			[
				'label' => esc_attr__( 'Exclude Posts', 'fixter' ),
				'description' => esc_attr__( 'Exclude posts that you don\'t want to appear. Write ID of the post with comma separated. Example "10,11,15".', 'fixter' ),
...
// Register widget
Plugin::instance()->widgets_manager->register( new Fixter_Blogbox_Widget() );