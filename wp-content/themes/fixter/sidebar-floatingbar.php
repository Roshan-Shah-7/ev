...
if( !empty($fixter_theme_options['fbar_widget_column_layout']) ){
	$floatingbar_col = esc_attr($fixter_theme_options['fbar_widget_column_layout']);
}
?>

<div id="floatingbar-widgets" class="row multi-columns-row sidebar-container floatingbar-text-color-<?php echo sanitize_html_class($fixter_theme_options['fbar_text_color']); ?>" role="complementary">
