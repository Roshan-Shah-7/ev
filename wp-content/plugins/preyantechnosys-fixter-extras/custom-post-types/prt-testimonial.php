...
function preyantechnosys_fixter_cpt_tm_testimonial(){
	...
	function preyantechnosys_fixter_tm_testimonial_enter_title_here( $title ){
	...
	add_filter( 'enter_title_here', 'preyantechnosys_fixter_tm_testimonial_enter_title_here' );


	// Move Featured Image box from left to center only on CLIENTS custom_post_type
	add_action('do_meta_boxes', 'preyantechnosys_fixter_tm_testimonial_featured_image_box');
	function preyantechnosys_fixter_tm_testimonial_featured_image_box() {
...
add_action( 'init', 'preyantechnosys_fixter_cpt_tm_testimonial', 8 );
 ...
 *  Meta Box: Clients
 */
if ( ! function_exists( 'preyantechnosys_fixter_tm_testimonials_metabox_options' ) ) {
function preyantechnosys_fixter_tm_testimonials_metabox_options( $options ) {
	...
	$options[]    = array(
		...
		'title'     => esc_attr__('Fixter: Testimonial Details', 'tmte'),
...
add_filter( 'cs_metabox_options', 'preyantechnosys_fixter_tm_testimonials_metabox_options' );
