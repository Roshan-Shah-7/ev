...
$header_search = ( !isset($fixter_theme_options['header_search']) ) ? '1' : esc_attr($fixter_theme_options['header_search']);
...
<div class="header-controls">
	...
	<?php endif; ?>
	<?php
	$wc_header_icon = ( isset($fixter_theme_options['wc-header-icon']) && trim($fixter_theme_options['wc-header-icon'])!='' ) ? esc_attr($fixter_theme_options['wc-header-icon']) : '1' ;
