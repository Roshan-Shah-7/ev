...
class Fixter_Teambox_Widget extends Widget_Base{
	...
	public function get_title() {
		return esc_attr__( 'Team Box', 'fixter' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'style',
			[
				'label'			=> esc_attr__( 'Select Teambox Style', 'fixter' ),
		...
		$this->add_control(
			...
			[
				...
				'default' => esc_attr__( 'Our Team', 'fixter' ),
...
// Register widget
Plugin::instance()->widgets_manager->register( new Fixter_Teambox_Widget() );