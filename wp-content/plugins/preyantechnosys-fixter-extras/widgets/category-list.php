 ...
 * @since 1.0
 */
class fixter_category_list_widget extends WP_Widget {
	...
	public function __construct() {
		$widget_style = array('classname'   => 'fixter_category_list_widget',
							  'description' => esc_attr__('Show Category List of current Taxonomy.', 'fixter') );
		parent::__construct(
			'fixter_category_list_widget', // Base ID
			esc_attr__('Fixter Category/Group List Widget', 'fixter'), // Name
			$widget_style // Args
		);
	}
...
register_widget( 'fixter_category_list_widget' );