...
$skincolortwo = preyantechnosys_get_option('skincolortwo');
/*
...
$border_color = preyantechnosys_get_option('border_color');
...
if( $button_shape =='round'){
	...
	$global_button_shape = '3px';
}
else {
	$global_button_shape = '0px';
}
$resposive_main_heading_font  = preyantechnosys_get_option('resposive_heading_font');
...
if( function_exists('preyantechnosys_fixter_cs_framework_init') && ($heading_font['family'] == 'Cerebri Sans')){
	echo '@import "'.get_template_directory_uri() .'/fonts/CerebriSans.css";';
}
if($heading_font['family'] == 'Magnita'){
	echo '@import "'.get_template_directory_uri() .'/fonts/Magnita.css";';
	echo '@import "'.get_template_directory_uri() .'/fonts/satoshi.css";';
}
...
:root {
	...
	--prt-bordercolor:<?php echo esc_attr($border_color); ?>;
	--prt-skincolor:<?php echo esc_attr($skincolor); ?>;
	--prt-skincolortwo:<?php echo esc_attr($skincolortwo); ?>;
...
.prt-header-overlay .prt-titlebar-wrapper .prt-titlebar-inner-wrapper{	
	padding-top: <?php echo esc_attr( $header_height)-15; ?>px;
}
...
<?php 
if( !empty($resposive_main_heading_font) ){ ?>
@media (max-width:991px) {
.prt-element-heading-content-wrapper .prt-element-content-heading{
    font-size:<?php echo esc_attr($resposive_main_heading_font); ?>px;
    line-height:<?php echo esc_attr(($resposive_main_heading_font)+15); ?>px;
}
}
<?php } 
/******************************************************/
