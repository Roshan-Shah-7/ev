...
class Fixter_Sliderimgbox_Widget extends Widget_Base{
	...
	public function get_title() {
		return esc_attr__( 'Slider Box', 'fixter' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'shortdesc',
			[
				'label' => esc_attr__( 'Short Description', 'fixter' ),
				'type' => Controls_Manager::TEXTAREA,
				'placeholder' => esc_attr__( 'Enter short description text', 'fixter' ),
			]
		);
		$this->add_control(
			'btn_title',
			...
			[
				...
				'default'	=> [
					[
						...
						'icon'		=> esc_attr__( 'icon add', 'fixter' ),
					],
					[
						'image'		=> get_template_directory_uri() . '/images/placeholder.png',
...
// Register widget
Plugin::instance()->widgets_manager->register( new Fixter_Sliderimgbox_Widget() );