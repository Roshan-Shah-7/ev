...
function preyantechnosys_fixter_cpt_tm_portfolio(){

	$fixter_theme_options = get_option('fixter_theme_options');
	
	$pf_type_title          = ( !empty($fixter_theme_options['pf_type_title']) ) ? $fixter_theme_options['pf_type_title'] : 'Portfolio' ;
	...
	$pf_type_slug           = ( !empty($fixter_theme_options['pf_type_slug']) ) ? $fixter_theme_options['pf_type_slug'] : 'portfolio' ;
	
	$pf_cat_title          = ( !empty($fixter_theme_options['pf_cat_title']) ) ? $fixter_theme_options['pf_cat_title'] : 'Portfolio Categories' ;
	$pf_cat_title_singular = ( !empty($fixter_theme_options['pf_cat_title_singular']) ) ? $fixter_theme_options['pf_cat_title_singular'] : 'Portfolio Category' ;
	$pf_cat_slug           = ( !empty($fixter_theme_options['pf_cat_slug']) ) ? $fixter_theme_options['pf_cat_slug'] : 'portfolio-category' ;
...
add_action( 'init', 'preyantechnosys_fixter_cpt_tm_portfolio', 8 );
 ...
 */
if ( ! function_exists( 'preyantechnosys_fixter_tm_portfolio_metabox_options' ) ) {
function preyantechnosys_fixter_tm_portfolio_metabox_options( $options ) {
	...
	$list_array    = array();
	$options_array = array();
	if( isset($fixter_theme_options['pf_details_line']) && is_array($fixter_theme_options['pf_details_line']) && count( $fixter_theme_options['pf_details_line'] ) > 0 ){
		foreach( $fixter_theme_options['pf_details_line'] as $key=>$val ){
			
			$option_array = array(
				'id'         => 'pf_details_line_'.$key,
				'type'       => 'text',
				'title'      =>esc_attr__($val['pf_details_line_title'], 'fixter'),
			);
	...
	$options[]    = array(
		...
		'title'     => sprintf( esc_attr__('Fixter: %s List Options', 'tmte'), $pf_type_title_singular ),
	...
	$options[]    = array(
		...
		'title'     => sprintf( esc_attr__('Fixter: %s View Style', 'tmte'), $pf_type_title_singular ),
		'post_type' => 'tm_portfolio', // only here is important
		'context'   => 'normal',
		'priority'  => 'default',
		'sections'  => array(
				...
				'fields' => array(
					...
					array(
						...
						'options'       => array(
									...
									'style2' 	=> esc_attr__('Left image and right content Style2', 'tmte'),
	...
	$options[]    = array(
		...
		'title'     => esc_attr__('Fixter: Portfolio Like Option','tmte'),
		'post_type' => 'tm_portfolio', // only here is important
		'context'   => 'normal',
		'priority'  => 'default',
		'sections'  => array(
...
add_filter( 'cs_metabox_options', 'preyantechnosys_fixter_tm_portfolio_metabox_options' );