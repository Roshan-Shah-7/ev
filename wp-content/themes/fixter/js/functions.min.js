...
jQuery(window).load(function(){tm_reveal_img_animation();gsap.delayedCall(1,()=>ScrollTrigger.getAll().forEach((t)=>{t.refresh()}))});gsap.registerPlugin(ScrollTrigger,SplitText);gsap.config({nullTargetWarn:!1,trialWarn:!1});!function(){"object"!=typeof prt_box&&(window.prt_box={}),window.prt_stepsbox={},prt_stepsbox.shortcodes={}}(jQuery),function prt_coverbox(prt_step){prt_stepsbox.shortcodes.otaru_core_horizontal_accordion_showcase={},prt_step(document).ready(function(){prt_step_item.init()});var prt_step_item={init:function(){const prt_step_div=prt_step(".prt-covershow-box");prt_step_div.length&&prt_step_div.each(function(){var prt_step_div=prt_step(this);prt_step_item.tabItemStyle(prt_step_div),prt_step_item.initTab(prt_step_div)})},initTab:function(prt_step_div){const prt_step_title=prt_step_div.find(".prt-cover-header");prt_step_title.length&&prt_step_title.each(function(prt_item){const prt_step_div=prt_step(this),prt_step_parent=prt_step_div.parent(),prt_step_width=prt_step_parent.find(".elementor-widget"),prt_step_an=gsap.timeline({paused:!0});prt_step_parent.hasClass("active")||0!==prt_item||(prt_step_parent.addClass("active"),prt_step_an.play(0)),prt_step_div.on("click",function(){prt_step_parent.hasClass("active")&&prt_step_parent.index()!==prt_item?prt_step_parent.removeClass("active"):(prt_step_parent.addClass("active"),prt_step_an.play(0)),prt_step_parent.siblings(".active").removeClass("active"),prt_step_title.parent().each(function(prt_step_div){prt_step_div=prt_step_div<=prt_item?0:100;prt_step(this).css("transform","translate3d("+prt_step_div+"%, 0, 0)")})})})},tabItemStyle:function(prt_start){const prt_step_width=prt_start.find(".prt-covershow-item");prt_step_width.length&&prt_step_width.each(function(prt_step_div){prt_step_div++;var prt_item=prt_step(this).find(".prt-cover-header");prt_step_item.tabItemStyleDesktop(prt_step(this),prt_step_width,prt_item,prt_step_div)})},tabItemStyleDesktop:function(prt_step_div,prt_item,prt_start,prt_step_width){prt_start=prt_start.outerWidth();prt_step_div.css({width:"calc(100% - "+prt_item.length+" * "+prt_start+"px)",left:prt_start*prt_step_width+"px",transform:"translate3d(100%, 0, 0)"})}};prt_stepsbox.shortcodes.otaru_core_horizontal_accordion_showcase=prt_step_item}(jQuery);jQuery(".prt-topbar-content .language-title").click(function(){jQuery('.prt-topbar-content ul.polylang_langswitcher').slideToggle("slow");return!1});jQuery(document).ready(function(){setTimeout(function(){preyantechnosys_carousel()},100);jQuery('.preyantechnosys-element-blogbox-style1 .preyantechnosys-boxes-row-wrapper .prt-box-col-wrapper:first').addClass("active");jQuery('.preyantechnosys-element-blogbox-style1 .preyantechnosys-boxes-row-wrapper .prt-box-col-wrapper').hover(function(){jQuery('.preyantechnosys-element-blogbox-style1 .preyantechnosys-boxes-row-wrapper .prt-box-col-wrapper').removeClass("active");jQuery(this).addClass("active")})});function tms_hover_img(){const tsHoverImg=gsap.utils.toArray(".preyantechnosys-servicebox-styletwo ");tsHoverImg.forEach((target)=>{const tsImg=target.querySelector('.tm-animation-hover-img');const t1=gsap.timeline();t1.to(tsImg,{opacity:1,duration:0.4,scale:1,ease:"Power2.easeOut"})
...
jQuery(window).load(function(){tms_hover_img()})
var preyantechnosys_showcasebox=function(){jQuery('.prt_showcasebox_wrapper').each(function(){var parentDiv=jQuery(this);jQuery('.prt_showcasebox_wrapper .prt_showcasebox_contents').hover(function(){jQuery('.prt_showcasebox_wrapper .prt_showcasebox_contents').removeClass("active");jQuery(this).addClass("active")})})};jQuery(document).ready(function(){preyantechnosys_showcasebox()});jQuery(window).resize(function(){});jQuery(document).ready(function(){setTimeout(function(){preyantechnosys_carousel()},100);jQuery('.preyantechnosys-element-teambox-style3 .preyantechnosys-boxes-row-wrapper .prt-box-col-wrapper:first').addClass("active");jQuery('.preyantechnosys-element-teambox-style3 .preyantechnosys-boxes-row-wrapper .prt-box-col-wrapper').hover(function(){jQuery('.preyantechnosys-element-teambox-style3 .preyantechnosys-boxes-row-wrapper .prt-box-col-wrapper').removeClass("active");jQuery(this).addClass("active")})})