...
class Fixter_Portfoliobox_Widget extends Widget_Base{
	...
	public function get_title() {
		return esc_attr__( 'Portfolio Box Element', 'fixter' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default' => esc_attr__( 'Our Projects', 'fixter' ),
	...
	protected function render() {
		...
		if ( $posts->have_posts() ) {
				...
				<?php
				echo '<div class="prt-slick-arrows"><a rel="nofollow" class="prt-slick-arrow prt-slick-prev"><i class="prt-fixter-icon-arrow-left"></i></a><a rel="nofollow" class="prt-slick-arrow prt-slick-next"><i class="prt-fixter-icon-arrow-right"></i></a></div></div></div>';
			}				
			else {
			...
			<div class="preyantechnosys-box-heading-wrapper <?php echo preyantechnosys_wp_kses($headingclass); ?>">
				...
				if( function_exists('preyantechnosys_get_filterbutton') ){
					...
					echo trim($sortable_category_html);
				}
				?>
			</div>
			<?php } ?> 
...
// Register widget
Plugin::instance()->widgets_manager->register( new Fixter_Portfoliobox_Widget() );